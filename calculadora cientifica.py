...
Button(frame6, text="Pol(", width=3, height=1, font=fontBotao,command=botao_pol).grid(row=3, column=4, sticky="s" ,pady=1)
...
Button(frame6, text="cos", width=3, height=1, font=fontBotao,command=botao_cos).grid(row=7, column=4, pady=1)
